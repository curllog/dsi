...
- [dsi — .NET SDK Installer](#dsi-net-sdk-installer)
  - [Philosophy](#philosophy)
  - [Supported Platforms](#supported-platforms)
  - [Architecture Overview](#architecture-overview)
  - [Scope](#scope)
    - [What dsi does](#what-dsi-does)
    - [What dsi does NOT do](#what-dsi-does-not-do)
  - [Installation Target](#installation-target)
    - [Why user-level, not system-level](#why-user-level-not-system-level)
    - [PATH setup](#path-setup)
  - [Data Sources](#data-sources)
    - [Microsoft Release Metadata API](#microsoft-release-metadata-api)
    - [SDK Download URLs](#sdk-download-urls)
  - [File System Layout](#file-system-layout)
  - [CLI Interface](#cli-interface)
    - [Commands](#commands)
      - [`dsi ls-remote`](#dsi-ls-remote)
      - [`dsi install`](#dsi-install)
      - [`dsi ls`](#dsi-ls)
      - [`dsi update`](#dsi-update)
      - [`dsi uninstall`](#dsi-uninstall)
      - [`dsi prune`](#dsi-prune)
      - [`dsi info`](#dsi-info)
      - [`dsi selfupdate`](#dsi-selfupdate)
      - [`dsi selfuninstall`](#dsi-selfuninstall)
  - [Use Cases](#use-cases)
    - [Use Case 1: Fresh machine setup](#use-case-1-fresh-machine-setup)
    - [Use Case 2: Working on a project that requires an older SDK](#use-case-2-working-on-a-project-that-requires-an-older-sdk)
    - [Use Case 3: Checking for SDK updates](#use-case-3-checking-for-sdk-updates)
    - [Use Case 4: CI/CD pipeline](#use-case-4-cicd-pipeline)
    - [Use Case 5: Exploring a preview release](#use-case-5-exploring-a-preview-release)
    - [Use Case 6: Coexistence with system package manager](#use-case-6-coexistence-with-system-package-manager)
    - [Use Case 7: Windows user on WSL](#use-case-7-windows-user-on-wsl)
  - [Internal Modules](#internal-modules)
    - [1. Release Index Client](#1-release-index-client)
    - [2. SDK Downloader & Verifier](#2-sdk-downloader-verifier)
    - [3. SDK Manager (Filesystem Operations)](#3-sdk-manager-filesystem-operations)
    - [4. Platform Detection](#4-platform-detection)
    - [5. Shell Integration (via `install.sh`)](#5-shell-integration-via-installsh)
  - [Rust Crate Dependencies](#rust-crate-dependencies)
  - [Edge Cases & Considerations](#edge-cases-considerations)
    - [Minimum supported .NET version](#minimum-supported-net-version)
    - [Muxer version conflicts](#muxer-version-conflicts)
    - [Partial extraction recovery](#partial-extraction-recovery)
